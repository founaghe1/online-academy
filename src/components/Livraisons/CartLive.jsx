    ...
    <div>
        <div class="card cart-liv mb-5">
          ...
          <div class="d-flex justify-content-between aling-items-center">
              <button type="button" className="btn btn-sm btn-car" data-bs-toggle="modal" data-bs-target="#modal0"><GrView />Voir</button>
              <button type="button" className="btn btn-sm btn-cart" data-bs-toggle="modal" data-bs-target="#modal1"><FcAcceptDatabase/>Commentaire</button>
          </div>
        </div>
         {/* <!-- Modal --> */}
