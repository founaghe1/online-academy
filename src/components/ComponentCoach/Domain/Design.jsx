    ...
    <div className='container'>
      ...
      <div className='row'>
        <div className='_kolon col-xl-3 col-lg-4 col-md-6 col-sm-6 col-xs-12 d-flex justify-content-center mt-4'>
          <Link
            to='/coach/dashboard/domain/design/photo'
        ...
        <div className='_kolon col-xl-3 col-lg-4 col-md-6 col-sm-6 col-xs-12 d-flex justify-content-center mt-4'>
          <Link
            to='/coach/dashboard/domain/design/illustrator'
            className='join d-flex right-0'
          >
            <Card
              style={{ width: "15rem" }}
        ...
        <div className='_kolon col-xl-3 col-lg-4 col-md-6 col-sm-6 col-xs-12 d-flex justify-content-center mt-4'>
          <Link
            to='/coach/dashboard/domain/design/pro'
            className='join d-flex right-0'
          >
            <Card
              style={{ width: "15rem" }}
        ...
        <div className='_kolon col-xl-3 col-lg-4 col-md-6 col-sm-6 col-xs-12 d-flex justify-content-center mt-4'>
          <Link
            to='/coach/dashboard/domain/design/initiation'
            className='join d-flex right-0'
          >
            <Card
              style={{ width: "15rem" }}
