...
import "react-toastify/dist/ReactToastify.css";
 const RecuperationCourDesigIllustra = () => {
  ...
  const recupertache = async () => {
    ...
    const data = querySnapshot.docs
      ...
      .filter((cours) => cours.SousDomaine === "illustrator");
    setCours(data);
  };
  ...
  return (
    <>
      <h1>Cours Design Illustrator</h1>
...
export default RecuperationCourDesigIllustra;
